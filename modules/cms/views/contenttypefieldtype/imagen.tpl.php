...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-2" >
			<div id="imagenVisible" style="<?=$conf->default_value!=""?$conf->default_value:"display:none"?>">
				<center>
					<img src="<?=$conf->default_value?>" id="imagen-por-defecto" height="100px" >
					<a href="javascript:eliminarImagen()" class="k-button">Eliminar</a>
				</center>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-2">
			<label>Numero de valores <br/>(0 = Sin Limite)</label>
		</div>
		<div class="col-lg-10">
	...
	function cargaControlArchivo(){
		$("#default_value_file").kendoUpload({
			...
			success: function (e) {
				...
				$("#imagen-por-defecto").attr("src", e.response.default_value);
			}
		});
	}
