...
$tiposFoto = TipoFoto::model()->findAll("WHERE estatus = 1");
?>


<form id="formEdit" class="form-horizontal" method="POST" action="<?=$url("ecom/".$this->interfaz."/saveFoto")?>" enctype="multipart/form-data">
    ...
    <div class="form-group row">
      ...
      <div class="col-lg-10">
        <select name="tipo" class="form-control" required>
          ...
          <?foreach ($tiposFoto as $key => $value) {?>
