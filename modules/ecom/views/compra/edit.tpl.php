...
<form id="formEdit" class="form-horizontal" method="POST" action="<?=$url("ecom/".$this->interfaz."/save")?>" enctype="multipart/form-data">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title">Crear nota de venta</h4>
  </div>
  ...
  <div class="modal-body">
    ...
    <div class="form-group row">
      <label class="col-lg-2 col-form-label">Proveedor</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" name="proveedor" value="<?=$data->proveedor?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      <label class="col-lg-2 col-form-label">Almacén</label>
      <div class="col-lg-10">
  ...
  $(document).ready(function(){
    ...
    $('#formEdit').ajaxForm(function(response) { 
      ...
      if(response.error == undefined){
        ...
        var url = "<?=$url("ecom/".$this->interfaz."/detalle")?>?id=" + data.id;
