    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_1z" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_2z" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_3z" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_4z" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_4zm" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_2" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_3" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_4" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
    ...
    <div class="col-md-6 col-xs-12">
      <div class="panel panel-dashboard">
        ...
        <div class="panel-footer">
          ...
          <input type="text" id="fechainicio_4m" class="form-control datepicker mt-2" placeholder="Fecha" autocomplete="off">
...
function getContratacionesZona(){
  ...
  if(sError != ""){
    ...
    $.post("<?=$url("ecom/".$this->interfaz."/graficaContratacionesZona")?>", {"plazas":plazas, 'fecha':finicio}, function (response){
      console.log(response);
      if(response.data){
